...
class RusNameAnonymized(BaseAnonymizer):
    ...
    def _load_names(self) -> list:
        ...
        if not file_path:
            raise ValueError("Не указан параметр 'source' для rus_name")
    ...
    def _generate(self, value: str, row: dict = None) -> str:
        ...
        # Детерминированный выбор на основе хеша исходного значения
